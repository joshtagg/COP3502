...
void setVictor(Node * root) {
    ...
    if(root->l->victor == NULL && root->r->victor == NULL) {
        setVictor(root->l);
    }
    ...
    if(root->l == NULL && root->r == NULL) {
        ...
        printf("IF LEFT AND RIGHT IS NULL, root value is: %lld\n", root->value);
    ...
    //if left is null, right is node, recurse
        ...
        printf("IF LEFT IS NULL, RIGHT IS NODE, root value is: %lld\n", root->value);
        ...
        else if(root->left == NULL && root->r->victor == NULL) {
    ...
    //if right is null, left is node, recurse
        ...
        //-------------------------------------
        /*
        printf("pt.1*** IF RIGHT IS NULL, LEFT IS NODE, root value is: %lld\n", root->value);
        ...
        if(root->right != NULL && root->l->victor != NULL) {
        ...
        else if(root->right == NULL && root->l->victor != NULL) {
            printf("pt.3***\n");
            ...
            if(skillArray[nullCounter] > root->l->victor) {
                ...
                totalExcitement += abs(skillArray[nullCounter] - root->l->victor);
                root->victor = root->l->victor;
                printf("third if: current totalExcitement: %lld\n", totalExcitement);
            }
        ...
        else if(root->l->victor == NULL && root->right == NULL) {
            printf("!!!!!TEST\n");
            setVictor(root->l);
        }

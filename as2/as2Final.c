...
int main() {
    ...
    //This loop manages asking the min and max values and cutting the list in half based on
    //the user response and using the mid as the midpoint to create a new min or max value.
    //this loops until the program runs out of attempts
